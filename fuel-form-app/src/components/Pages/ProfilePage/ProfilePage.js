...
function ProfilePage() {
  ...
  function editProfileInfo() {
    //currProfInfoDisplay = document.getElementById('UserAddressDisplayID');
    //editProfInfoDisplay = document.getElementById('')
    //currProfInfoDisplay.style.display = "none";
  ...
  return (
    <div>
      ...
      <div classname='ProfileInfoEditing'>
        <form>
